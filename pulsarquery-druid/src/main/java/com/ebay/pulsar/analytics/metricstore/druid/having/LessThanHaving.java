 ...
 *
 */
public class LessThanHaving extends BaseHaving {
	private String aggregation;
	private String value;

	public LessThanHaving(String aggregation, String value) {
		super(HavingType.lessThan);
	...
	public byte[] cacheKey() {
		...
		return ByteBuffer.allocate(1 + aggregationBytes.length + valueBytes.length).put(HavingCacheHelper.LESS_THAN_CACHE_ID).put(aggregationBytes).put(valueBytes).array();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LessThanHaving other = (LessThanHaving) obj;
		if (aggregation == null) {
