 ...
 *
 */
public class OrHaving extends BaseHaving {
	private List<BaseHaving> havingSpecs;
	
	public OrHaving(List<BaseHaving> havingSpecs) {
		super(HavingType.or);
	...
	public byte[] cacheKey() {
		return HavingCacheHelper.computeCacheKey(HavingCacheHelper.OR_CACHE_ID, havingSpecs);
	}
