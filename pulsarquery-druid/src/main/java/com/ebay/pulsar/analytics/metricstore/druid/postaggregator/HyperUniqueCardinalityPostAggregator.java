...
public class HyperUniqueCardinalityPostAggregator extends BasePostAggregator {
	...
	public HyperUniqueCardinalityPostAggregator(String name, String fieldName) {
		super(PostAggregatorType.hyperUniqueCardinality, name);
	...
	public byte[] cacheKey() {
		...
		return ByteBuffer.allocate(1 + fieldNameBytes.length).put(PostAggregatorCacheHelper.HYPERUNIQUECARDINALITY_CACHE_ID).put(fieldNameBytes).array();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HyperUniqueCardinalityPostAggregator other = (HyperUniqueCardinalityPostAggregator) obj;
		if (fieldName == null) {
