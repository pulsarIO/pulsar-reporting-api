 ...
 *
 */
public class GreaterThanHaving extends BaseHaving {
	private String aggregation;
	private String value;

	public GreaterThanHaving(String aggregation, String value) {
		super(HavingType.greaterThan);
	...
	public byte[] cacheKey() {
		...
		return ByteBuffer.allocate(1 + aggregationBytes.length + valueBytes.length).put(HavingCacheHelper.GREATER_THAN_CACHE_ID).put(aggregationBytes).put(valueBytes).array();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GreaterThanHaving other = (GreaterThanHaving) obj;
		if (aggregation == null) {
