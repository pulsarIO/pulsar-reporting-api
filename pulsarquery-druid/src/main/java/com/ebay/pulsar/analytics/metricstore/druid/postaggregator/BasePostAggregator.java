...
public abstract class BasePostAggregator {
	private PostAggregatorType type;
	private String name;
	
	public BasePostAggregator(PostAggregatorType type, String name) {
		this.type = type;
		this.name = name;
	}
	
	public PostAggregatorType getType() {
		return type;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BasePostAggregator other = (BasePostAggregator) obj;
		if (name == null) {
			if (other.name != null)
				return false;
