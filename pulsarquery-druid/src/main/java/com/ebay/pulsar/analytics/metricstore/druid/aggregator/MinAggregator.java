 ...
 *
 */
public class MinAggregator extends BaseAggregator {
	private String fieldName;

	private static final byte CACHE_TYPE_ID = 0x4;

	public MinAggregator(String name, String fieldName) {
		super(AggregatorType.min, name);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MinAggregator other = (MinAggregator) obj;
		if (fieldName == null) {
